About r-shinydashboardplus-feedstock
====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-shinydashboardplus-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5783&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-shinydashboardplus-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-shinydashboardplus` can be installed with `conda`:
...
```
mamba install r-shinydashboardplus
```

It is possible to list all of the versions of `r-shinydashboardplus` available on your platform with `conda`:
...
```
mamba search r-shinydashboardplus --channel conda-forge
```
...
mamba repoquery search r-shinydashboardplus --channel conda-forge

# List packages depending on `r-shinydashboardplus`:
mamba repoquery whoneeds r-shinydashboardplus --channel conda-forge

# List dependencies of `r-shinydashboardplus`:
mamba repoquery depends r-shinydashboardplus --channel conda-forge
```
